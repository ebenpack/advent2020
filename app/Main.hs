  ...
  where
    day =
      option
        ...
        (long "day" <>
         ...
         metavar "DAY" <>
         help
           "Choose a day to print the solutions for. Omitting this option will print out all days.")
    input =
      optional $
      strOption
        (long "input" <>
    ...
    allDays =
      flag'
        ...
        (long "all-days" <>
         help
           "Present solutions for all of the days of Advent of Code, with default input file names.")
    ...
    verbosityParser =
      switch
        (long "verbosity" <>
         short 'v' <>
         help
           "Whether to print out extra info, such as the result of the input parser, and more detailed error messages.")
  ...
  case d of
    ...
    OneDay {..} ->
      let action = (validate day >>= (days Map.!?))
       in case action of
            Nothing ->
              putStrLn "Invalid day provided. There are 25 days in Advent."
            Just (d, i) -> do
